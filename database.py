...
def init_bd():
    '''
    # Inicializar o banco de dados criando a tabela 'ordens' se ela ainda não existir. Seguro para chamar múltiplas vezes.
    '''
    conn = get_connection()
    ...
    #Commit() Salvar alterações no arquivo .bd
    conn.commit()
